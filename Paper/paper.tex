...
Furthermore, we only use interpolated frames that are a user-prescribed amount away in time for each given reordered frame, to avoid ghosting artifacts~\cite{meyer2015phase}.
